...
func TestCLI(t *testing.T) {
	...
	t.Run(
		"start game with 3 players and finish game with 'Chris' as winner", func(t *testing.T) {
			game := &GameSpy{}
	...
	t.Run(
		"start game with 8 players and record 'Cleo' as winner", func(t *testing.T) {
			game := &GameSpy{}
	...
	t.Run(
		"it prints an error when the winner is declared incorrectly", func(t *testing.T) {
			game := &GameSpy{}
...
func assertGameStartedWith(t testing.TB, game *GameSpy, numberOfPlayersWanted int) {
	...
	passed := retryUntil(
		500*time.Millisecond, func() bool {
