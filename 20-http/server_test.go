...
func TestGETPlayers(t *testing.T) {
	...
	t.Run(
		"returns Pepper's score", func(t *testing.T) {
	...
	t.Run(
		"returns Floyd's score", func(t *testing.T) {
	...
	t.Run(
		"returns 404 on missing players", func(t *testing.T) {
...
func TestStoreWins(t *testing.T) {
	...
	t.Run(
		"it records wins on POST", func(t *testing.T) {
			player := "Pepper"
...
func TestLeague(t *testing.T) {
	...
	t.Run(
		"it returns the League table as JSON", func(t *testing.T) {
...
func TestGame(t *testing.T) {
	t.Run(
		"GET /game returns 200", func(t *testing.T) {
	...
	t.Run(
		"start a game with 3 players, send some blind alerts down WS and declare Ruth the winner",
		func(t *testing.T) {
